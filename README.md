...
Invoices touched by returned logs are reloaded with their complete payment history,
including settled payments on expired invoices, before replay matching. If that
history cannot be loaded, processing stops before assigning payment IDs.
