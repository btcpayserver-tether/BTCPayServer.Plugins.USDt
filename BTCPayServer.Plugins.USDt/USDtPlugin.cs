...
public class USDtPlugin : BaseBTCPayServerPlugin
{
    ...
    private void RegisterServices(IServiceCollection services)
    {
        ...
        EthUSDtLikeConfigurationItem? ethUsdtConfiguration = null;
        ...
        {
            pluginConfiguration.EthereumUSDtLikeConfigurationItems.Add(ethUsdtConfiguration.GetPaymentMethodId(), ethUsdtConfiguration);
        }
    ...
    private static EthUSDtLikeConfigurationItem GetEthUSDtHardcodedConfig(ChainName chainName)
    {
        return chainName switch
        {
            _ when chainName == ChainName.Mainnet => new EthUSDtLikeConfigurationItem
            {
                Chain = Constants.EthereumChainName,
                Currency = Constants.USDtCurrency,
                CurrencyDisplayName = Constants.USDtCurrencyDisplayName,
            ...
            _ when chainName == ChainName.Testnet => new EthUSDtLikeConfigurationItem
            {
                Chain = Constants.EthereumChainName,
                Currency = Constants.USDtCurrency,
                CurrencyDisplayName = Constants.USDtCurrencyDisplayName,
