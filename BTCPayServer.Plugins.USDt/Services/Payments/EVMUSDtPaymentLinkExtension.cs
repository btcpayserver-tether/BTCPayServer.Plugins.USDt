    ...
    : IPaymentLinkExtension
{
    ...
    public string? GetPaymentLink(PaymentPrompt prompt, IUrlHelper? urlHelper)
    {
        ...
        var scale = 1m;
        for (var i = 0; i < configuration.Divisibility; i++) scale *= 10m;
        ...
        return $"ethereum:{configuration.SmartContractAddress.ToLowerInvariant()}@{configuration.ChainId}/transfer?address={to}&uint256={amountUnits}";
    }
}